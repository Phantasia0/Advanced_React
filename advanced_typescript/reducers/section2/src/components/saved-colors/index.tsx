import React, { Dispatch, useState } from "react"; // Importing useState from React
...
import { ColorActions } from "../../reducer/color-reducer"; // Importing the SavedColor component
